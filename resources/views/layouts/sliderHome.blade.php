<div id="carouselExampleControls" class="carousel slide carousel-fade" data-ride="carousel">
  <ol class="carousel-indicators">
    <li data-target="#carouselExampleControls" style="" data-slide-to="0" class="active"></li>
    <li data-target="#carouselExampleControls" style="" data-slide-to="1"></li>
    <li data-target="#carouselExampleControls" style="" data-slide-to="2"></li>
  </ol>
  <div class="carousel-inner">
    <div class="carousel-item active">
      ...
      <div class="carousel-caption  d-md-block">
        ...
        <!-- <button type="button" class="btn btn-success"> <a href="#categoriesSection"> View the Species </a></button> -->
      </div>
    </div>
